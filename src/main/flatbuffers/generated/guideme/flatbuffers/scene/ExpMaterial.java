...
public final class ExpMaterial extends Table {
  ...
  public guideme.flatbuffers.scene.ExpSampler samplers(int j) { return samplers(new guideme.flatbuffers.scene.ExpSampler(), j); }
  public guideme.flatbuffers.scene.ExpSampler samplers(guideme.flatbuffers.scene.ExpSampler obj, int j) { int o = __offset(14); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int samplersLength() { int o = __offset(14); return o != 0 ? __vector_len(o) : 0; }
  public guideme.flatbuffers.scene.ExpSampler.Vector samplersVector() { return samplersVector(new guideme.flatbuffers.scene.ExpSampler.Vector()); }
  public guideme.flatbuffers.scene.ExpSampler.Vector samplersVector(guideme.flatbuffers.scene.ExpSampler.Vector obj) { int o = __offset(14); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
