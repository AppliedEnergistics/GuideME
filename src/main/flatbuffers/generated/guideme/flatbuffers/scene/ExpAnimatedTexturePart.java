...
public final class ExpAnimatedTexturePart extends Table {
  ...
  public guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame frames(int j) { return frames(new guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame(), j); }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame frames(guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o) + j * 4, bb) : null; }
  public int framesLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame.Vector framesVector() { return framesVector(new guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame.Vector()); }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame.Vector framesVector(guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame.Vector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
