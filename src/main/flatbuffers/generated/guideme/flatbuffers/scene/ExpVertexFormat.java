...
public final class ExpVertexFormat extends Table {
  ...
  public guideme.flatbuffers.scene.ExpVertexFormatElement elements(int j) { return elements(new guideme.flatbuffers.scene.ExpVertexFormatElement(), j); }
  public guideme.flatbuffers.scene.ExpVertexFormatElement elements(guideme.flatbuffers.scene.ExpVertexFormatElement obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o) + j * 7, bb) : null; }
  public int elementsLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public guideme.flatbuffers.scene.ExpVertexFormatElement.Vector elementsVector() { return elementsVector(new guideme.flatbuffers.scene.ExpVertexFormatElement.Vector()); }
  public guideme.flatbuffers.scene.ExpVertexFormatElement.Vector elementsVector(guideme.flatbuffers.scene.ExpVertexFormatElement.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 7, bb) : null; }
