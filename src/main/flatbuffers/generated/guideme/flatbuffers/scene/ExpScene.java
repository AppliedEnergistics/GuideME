...
public final class ExpScene extends Table {
  ...
  public guideme.flatbuffers.scene.ExpCameraSettings camera() { return camera(new guideme.flatbuffers.scene.ExpCameraSettings()); }
  public guideme.flatbuffers.scene.ExpCameraSettings camera(guideme.flatbuffers.scene.ExpCameraSettings obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  public guideme.flatbuffers.scene.ExpMesh meshes(int j) { return meshes(new guideme.flatbuffers.scene.ExpMesh(), j); }
  public guideme.flatbuffers.scene.ExpMesh meshes(guideme.flatbuffers.scene.ExpMesh obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int meshesLength() { int o = __offset(6); return o != 0 ? __vector_len(o) : 0; }
  public guideme.flatbuffers.scene.ExpMesh.Vector meshesVector() { return meshesVector(new guideme.flatbuffers.scene.ExpMesh.Vector()); }
  public guideme.flatbuffers.scene.ExpMesh.Vector meshesVector(guideme.flatbuffers.scene.ExpMesh.Vector obj) { int o = __offset(6); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePart animatedTextures(int j) { return animatedTextures(new guideme.flatbuffers.scene.ExpAnimatedTexturePart(), j); }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePart animatedTextures(guideme.flatbuffers.scene.ExpAnimatedTexturePart obj, int j) { int o = __offset(8); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int animatedTexturesLength() { int o = __offset(8); return o != 0 ? __vector_len(o) : 0; }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePart.Vector animatedTexturesVector() { return animatedTexturesVector(new guideme.flatbuffers.scene.ExpAnimatedTexturePart.Vector()); }
  public guideme.flatbuffers.scene.ExpAnimatedTexturePart.Vector animatedTexturesVector(guideme.flatbuffers.scene.ExpAnimatedTexturePart.Vector obj) { int o = __offset(8); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
