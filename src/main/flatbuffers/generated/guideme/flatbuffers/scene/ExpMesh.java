...
public final class ExpMesh extends Table {
  ...
  public guideme.flatbuffers.scene.ExpMaterial material() { return material(new guideme.flatbuffers.scene.ExpMaterial()); }
  public guideme.flatbuffers.scene.ExpMaterial material(guideme.flatbuffers.scene.ExpMaterial obj) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  public guideme.flatbuffers.scene.ExpVertexFormat vertexFormat() { return vertexFormat(new guideme.flatbuffers.scene.ExpVertexFormat()); }
  public guideme.flatbuffers.scene.ExpVertexFormat vertexFormat(guideme.flatbuffers.scene.ExpVertexFormat obj) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
